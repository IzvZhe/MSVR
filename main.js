...
function init() {
    ...
    lui.add(cam3D, 'mConvergence', 200, 2000, 100)
    lui.add(cam3D, 'mEyeSeparation', 0, 1, 0.01)
    lui.add(cam3D, 'mFOV', 0, 2, 0.01)
    lui.add(cam3D, 'mNearClippingDistance', 1, 19, 0.1)
